...
const Contact = () => {
  return (
    ...
    <h2>Contact Us</h2>
      ...
      <div className="m-3 w-100" style={{outline:"none"}}> <input type="mail" className=' w-100 p-2 shadow rounded-2' placeholder="your email here"style={{outline:"none",border:"none"}} /></div>
      <button className="btn btn-secondary px-4">Send</button>
      <p><span className="h1">Y</span>ou can also reach out us on different Social Media</p>
      <div className="d-flex  align-items-center justify-content-center">
      <i className="bi bi-telephone text-dark fs-3 icon m-2" style={{cursor: "pointer"}}></i>
      ...
      <i className="bi bi-tiktok text-dark fs-3 icon m-2" style={{cursor: "pointer"}}></i>
      <i className="bi bi-instagram text-danger fs-3 icon m-2" style={{cursor: "pointer"}}></i>
      </div>
      </div>
    </div>
  );
